            ...
            <div class="d-flex flex-row">
                ...
                <div class="p-2">
                    <div class="card-body">
                        ...
                        <a  href="{{route('posts.edit', ['post' => $post->id])}}" class="btn btn-primary align-self-end">Edit</a>
                        <a  href="{{route('posts.destroy', ['post' => $post->id])}}" class="btn btn-primary align-self-end">Delete</a>
                    </div>
                </div>
            </div>
        </div>

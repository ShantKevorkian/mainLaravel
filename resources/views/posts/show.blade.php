            ...
            <div class="flex-column">
                <div class="flex-column align-items-center">
                    <img
                        ...
                        src="{{ $post->user->avatar ? asset('/storage/' . $post->user->avatar->path) : asset('/images/postDefault.png') }}"
                        alt="Card image cap"
                        style="width: 100px;height: 100px"
                    />
                    <p>Name: {{ $post->user->name }}</p>
                    <a href="{{route('profile.guest', ['guest' => $post->user->id])}}" class="btn btn-primary align-self-end">
                        See Profile
                    </a>
                </div>
            </div>
